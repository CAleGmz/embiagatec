    ...
    <?php
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            if(empty($errores)){
                ...
                $query = "INSERT INTO clientes (nombre,apellido,telefono,id_usuario) VALUES ('${nombre}' , '${apellido}', '${telefono}', '$id');";
                $resultado = mysqli_query($db,$query);
            ...
            <form method="POST" class="formulario">
                <fieldset>
                    ...
                    <div class="contenedor-campos">                        
                        ...
                        <input class="input-text" name="apellido" type = "text" placeholder = "Apellidos" required>
                        </div>

                        <div class="campo">
                        <label> Telefono </label>
                        <input class="input-text" name="telefono" type = "tel" placeholder = "Telefono" required>
                        </div>

                        <div>
                            <input class="boton3" type = "submit" value = "Registrarse">
                        </div>
                    </div>
                </fieldset>
            </form>
